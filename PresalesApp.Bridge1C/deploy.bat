...
ssh -i ~\.ssh\presales_monitor_prod presale@presalesapp.ru "./bridge_deploy" >nul 2>&1 && echo    [102mService updated successfully.[0m || echo    [101mError. Something went wrong. NEED TO CONNECT AND FIX.[0m
pause