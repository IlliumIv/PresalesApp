...
echo 	Send package...
scp -i ~\.ssh\presalesMonitor %cd%\PresalesMonitor.Server.7z illium@presalesapp.ru:~/  >nul 2>&1 && echo 	Package sent successfully. || echo Error. Unable send package. && exit 1