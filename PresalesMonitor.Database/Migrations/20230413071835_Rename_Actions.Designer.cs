...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Database.Entities.Presale", b =>
                {
                    b.Property<int>("PresaleId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Database.Entities.PresaleAction", b =>
                {
            ...
            modelBuilder.Entity("Database.Entities.ProfitPeriod", b =>
                {
            ...
            modelBuilder.Entity("Database.Entities.Invoice", b =>
                {
                    b.HasOne("Database.Entities.Presale", "Presale")
                        .WithMany("Invoices")
            ...
            modelBuilder.Entity("Database.Entities.ProfitPeriod", b =>
                {
                    b.HasOne("Database.Entities.Invoice", null)
            ...
            modelBuilder.Entity("Database.Entities.Project", b =>
                {
                    b.HasOne("Database.Entities.Project", "MainProject")
                        .WithMany()
