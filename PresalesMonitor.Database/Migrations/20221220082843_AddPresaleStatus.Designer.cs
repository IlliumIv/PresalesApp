...
namespace PresalesMonitor.Database.Migrations
{
    ...
    [Migration("20221220082843_AddPresaleStatus")]
    partial class AddPresaleStatus
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PresalesMonitor.Entities.Invoice", b =>
                {
            ...
            modelBuilder.Entity("PresalesMonitor.Entities.Presale", b =>
                {
                    b.Property<int>("PresaleId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PresalesMonitor.Entities.PresaleAction", b =>
                {
            ...
            modelBuilder.Entity("PresalesMonitor.Entities.ProfitPeriod", b =>
                {
            ...
            modelBuilder.Entity("PresalesMonitor.Entities.Project", b =>
                {
                    b.Property<int>("ProjectId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PresalesMonitor.Entities.Invoice", b =>
                {
                    b.HasOne("PresalesMonitor.Entities.Presale", "Presale")
                        .WithMany("Invoices")
                        .HasForeignKey("PresaleId");

                    b.HasOne("PresalesMonitor.Entities.Project", "Project")
                        .WithMany("Invoices")
            ...
            modelBuilder.Entity("PresalesMonitor.Entities.ProfitPeriod", b =>
                {
                    b.HasOne("PresalesMonitor.Entities.Invoice", null)
            ...
            modelBuilder.Entity("PresalesMonitor.Entities.Project", b =>
                {
                    b.HasOne("PresalesMonitor.Entities.Project", "MainProject")
                        .WithMany()
